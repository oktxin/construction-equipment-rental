...
const footerLinks = [
  ...
  { label: "Правила аренды", to: "/#rental-flow" },
  ...
  return (
    <footer className="border-t border-border/60 bg-secondary text-background">
      <div className="mx-auto grid max-w-[1440px] gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1.2fr_0.8fr_0.8fr] lg:px-8">
        <div className="space-y-4">
          <div>
            ...
            <p className="mt-3 max-w-md text-sm leading-7 text-background/68">
              Платформа аренды строительной техники с понятной заявкой, контролем статусов и аккуратным разделением клиентского и административного сценариев.
            </p>
          </div>
        </div>

        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Разделы</p>
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Контакты</p>
      ...
      <div className="border-t border-white/8 px-4 py-4 text-center text-xs uppercase tracking-[0.18em] text-background/45 sm:px-6 lg:px-8">
        BuildRent | русская интерфейсная основа
      </div>
    </footer>
  );
}
